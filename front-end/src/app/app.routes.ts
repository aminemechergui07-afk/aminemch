...
export const routes: Routes = [
  ...
  {path: 'client' , canActivate:[authGuard] ,loadComponent: ()=>import('./pages/client/client.component').then(c=>c.ClientComponent),children:[
    ...
    {path: 'stats' ,loadComponent: ()=>import('./pages/client/stats/stats.component').then(c=>c.StatsComponent)},
    ...
    {path: 'proposals' ,loadComponent: ()=>import('./pages/client/proposals/proposals.component').then(c=>c.ProposalsComponent)},
